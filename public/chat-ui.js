(function() {
  ...
  function buildLoginScreen() {
    return '<div id="kc-login">' +
      '<div class="kc-login-card">' +
        '<div class="kc-logo">' +
          '<svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#1783FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>' +
        '</div>' +
        '<h1 class="kc-login-title">Kimi</h1>' +
        '<p class="kc-login-subtitle">Your AI assistant</p>' +
    ...
    return '<div id="kc-app">' +
      ...
      '<main id="kc-main">' +
        '<header id="kc-header" class="kc-header">' +
          ...
          '</button>' +
          '<span id="kc-header-title" class="kc-header-title">Kimi</span>' +
          '<div class="kc-header-right"></div>' +
        '</header>' +
        '<div id="kc-chat-view" class="kc-chat-view">' +
          '<div class="kc-empty-state" id="kc-empty-state">' +
            '<svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#1783FF" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>' +
            '<h2>Kimi</h2>' +
            '<p>Start a conversation or select an existing chat</p>' +
          '</div>' +
  ...
  function handleGoogleLogin() {
    if (typeof firebase !== 'undefined' && firebase.auth) {
      ...
      showLoginError('Firebase SDK failed to load. Please refresh the page.');
    }
  }
